...
<body>
  <h2>Generate CSR and Un-Encrypted Private Key (Algorithm: RSA, Key-Length Options: 2048 & 4096)</h2>
  <h4>CN will be auto added in SAN.</h4>
  <form method="post">
    <span style="margin-right: 153px;">Select Key-Size :</span>
    <select name="key_size_value">
...
def generate_csr():
    if request.method == 'POST':
        ...
        key_size_selected = request.form.get("key_size_value")
        key_size = int(key_size_selected)
